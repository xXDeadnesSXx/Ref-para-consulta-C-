...
namespace DCP_OMNI.Controllers
{
    public class MateriaisController : Controller
    {
        ...
        public MateriaisController(DCP_OMNIContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Marca,Estoque")] Material material)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Marca,Estoque")] Material material)
        {
            if (id != material.Id)
            {
                return NotFound();
